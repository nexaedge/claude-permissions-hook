...
- document command-wrapper transparency limitation ([a343bb8](https://github.com/nexaedge/claude-permissions-hook/commit/a343bb82d41903aa85df29b26f2e95e6a83089e2))

### Refactoring

- tighten API surface and clean up tests ([3d7c7ed](https://github.com/nexaedge/claude-permissions-hook/commit/3d7c7ed872bdce8037710d531d5283abc263854a))
- add domain type wrappers ([ded55de](https://github.com/nexaedge/claude-permissions-hook/commit/ded55de9a9fb0bf0750a61165399961485daa5c0))
- layer config into parse/normalize/match ([d9b2fb6](https://github.com/nexaedge/claude-permissions-hook/commit/d9b2fb6f03bc1017164079f6106c30fa50e1d295))
- introduce typed tool routing ([9e9233f](https://github.com/nexaedge/claude-permissions-hook/commit/9e9233f9c00831240112095c2bbed04c47f6f388))
- split decision module into submodules ([2b793dd](https://github.com/nexaedge/claude-permissions-hook/commit/2b793dd1bc56eb072bb5d5d0c09fbcc17bcba806))

### Miscellaneous

- add contract tests and golden corpus harness ([f8b6abc](https://github.com/nexaedge/claude-permissions-hook/commit/f8b6abcd2b9c4915891656ec8305a284d52e24c2))
## [0.4.0] - 2026-02-18

### Features

- integrate file tools into decision engine ([dbb8823](https://github.com/nexaedge/claude-permissions-hook/commit/dbb88230eb19dafccbdc2c3e098891b0fd4bdd01))
- add files config parser with hybrid KDL syntax ([9744ed9](https://github.com/nexaedge/claude-permissions-hook/commit/9744ed970bb3ea5e1c2adc93023846a8fa787605))
- add path engine with normalization and glob matching ([0d97831](https://github.com/nexaedge/claude-permissions-hook/commit/0d9783185b36819f579d2fab0d9e0d7a834a19f9))
- add file tool path extraction from tool_input ([b5e6228](https://github.com/nexaedge/claude-permissions-hook/commit/b5e6228a00d595c2b5fc1d0cc06d366fb13e3b0c))
...
- add files section to example config ([58262f7](https://github.com/nexaedge/claude-permissions-hook/commit/58262f76ae792c4101aa2afc3faa9c1f0a3725a2))

### Miscellaneous

- fix rustfmt formatting in integration tests ([aaee315](https://github.com/nexaedge/claude-permissions-hook/commit/aaee31581662b7563735f1d1d493be925aca0d28))
- add file tool integration tests ([a6d8ea8](https://github.com/nexaedge/claude-permissions-hook/commit/a6d8ea8a102a542807420762b82d46951c4ef8c3))
## [0.3.0] - 2026-02-18
...
- handle BrokenPipe in cli test helper ([1671a65](https://github.com/nexaedge/claude-permissions-hook/commit/1671a6549d0eabf7e546693b2322c679c4617d21))

### Miscellaneous

- add conventional commits, changelog generation, and parallel CI ([6f27aad](https://github.com/nexaedge/claude-permissions-hook/commit/6f27aadf859e7179293c1ca25bd669fbd50beb0a))
## [0.2.0] - 2026-02-17
